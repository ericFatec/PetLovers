...
export default class ProductServiceTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  toggleProductModal() {
    this.setState((prevState) => ({
      isProductModalOpen: !prevState.isProductModalOpen,
    }));
  }

  toggleServiceModal() {
    this.setState((prevState) => ({
      isServiceModalOpen: !prevState.isServiceModalOpen,
    }));
  }

  render() {
    const { isProductModalOpen, isServiceModalOpen } = this.state;
    return (
      <>
        ...
        <div className="flex flex-wrap gap-6 justify-center">
          ...
          <div className="w-auto">
            ...
            <div className="mt-6 flex justify-center">
              <button onClick={this.toggleProductModal} className="bg-heart-peach-300 text-dog-brown-400 py-2 px-6 rounded-full">
          ...
          <div className="w-auto">
            ...
            {/* Add Service Button */}
            <div className="mt-6 flex justify-center">
              <button onClick={this.toggleServiceModal} className="bg-heart-peach-300 text-dog-brown-400 py-2 px-6 rounded-full">
          ...
          <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-8 rounded-lg shadow-lg w-96">
              <div className="flex justify-between items-center mb-4">
                ...
                <button onClick={this.toggleProductModal} className="text-gray-500 text-xl">&times;</button>
              </div>
          ...
          <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-8 rounded-lg shadow-lg w-96">
              <div className="flex justify-between items-center mb-4">
                ...
                <button onClick={this.toggleServiceModal} className="text-gray-500 text-xl">&times;</button>
              </div>
